...
use Gii\ModuleService\Schemas\Service;
use Zahzah\ModulePatient\Contracts\PatientType as ContractsPatientType;
use Illuminate\Database\Eloquent\{
    Builder, Collection, Model
};
use Zahzah\ModulePatient\Resources\PatientType\{
    ShowPatientType, ViewPatientType
};
