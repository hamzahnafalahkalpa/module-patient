...
use Zahzah\ModulePatient\Contracts\VisitPatient as ContractsVisitPatient;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Zahzah\ModulePatient\Enums\VisitPatient\{
    Activity, ActivityStatus, VisitStatus
};
use Zahzah\ModulePatient\ModulePatient;
use Zahzah\ModulePatient\Resources\VisitPatient\{
    ShowVisitPatient, ViewVisitPatient
};
...
class VisitPatient extends ModulePatient implements ContractsVisitPatient
{
    ...
    protected function newVisitPatient(Model $visit_patient_model, array &$attributes) : Model{
        ...
        $visit_patient_model->sync($patient,[
            'nik','passport','crew_id','bpjs_code','prop_people','medical_record'
        ]);
    ...
    public function showUsingRelation(): array{
        return [
            ...
            },'organizations','transaction.consument','services','payer','agent'
        ];
    }
    ...
    public function commonPaginate($paginate_options): LengthAwarePaginator{
        return $this->visitPatient()->with(['visitRegistrations' => function($q){
                    $q->with([
                        'medicService.service', 'patientType', 'headDoctor']);
