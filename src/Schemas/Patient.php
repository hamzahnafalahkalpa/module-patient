...
use Zahzah\ModulePatient\Contracts\Patient as ContractsPatient;
...
class Patient extends People implements ContractsPatient {
    ...
    public function prepareStorePatient(?array $attributes = null): Model{
        ...
        switch ($reference_type) {
            case 'ANIMAL': break;
            default      : $reference = $this->createPeople($patient,$attributes);break;
        }
    ...
    protected function createPeople(Model &$patient,$attributes): Model{
        ...
        $people    = $this->schemaContract('people')->prepareStorePeople($this->assocRequest(
            'reference_id', 'nik','passport', 'residence_same_ktp',
            'addresses','email','father_name','mother_name','nationality',
