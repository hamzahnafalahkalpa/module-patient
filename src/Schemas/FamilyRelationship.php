...
use Hanafalah\ModulePatient\Contracts\FamilyRelationship as ContractsFamilyRelationship;
...
class FamilyRelationship extends PackageManagement implements ContractsFamilyRelationship
{
    ...
    {
        $datas =  $this->familyRelationship(function ($query) {})->paginate(request('per_page'))->appends(request()->all());
        return $datas;
    }
