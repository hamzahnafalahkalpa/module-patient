...
class VisitPatient extends BaseModel{
    ...
    protected $list       = [
        'id','parent_id','visit_code','patient_id',
        'reference_id','reference_type',
        'flag','reservation_id','queue_number',
        'visited_at','reported_at','status','props'
    ];
    protected $show = [];
    ...
    public function services(){
        return $this->belongsToManyModel(
            ...
            'model_has_services.reference_id','service_id'
